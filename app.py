...
# --------------------------------------------------------------------------------
st.set_page_config(page_title="RR.HH Integrado con Mapeo", page_icon="👥")
...
def setup_sidebar():
    ...
    with st.sidebar.expander("ℹ️ Cómo usar esta aplicación", expanded=False):
        st.write(
            ...
            2. Use los filtros para el período y estado del trabajador.
            3. Elija el análisis deseado.
            4. Si hace falta, mapee las columnas para adaptar nombres.
            """
        )
    ...
    if uploaded_file:
        try:
            with st.spinner("Procesando datos..."):
                df_loaded = cached_load_data(uploaded_file)
